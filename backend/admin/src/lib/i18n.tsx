...
const en = {
  ...
  editExhibitHint:
    'Edit this exhibit like a blog post. Saving updates the primary language and fills missing translations.',
  primaryLanguage: 'Primary language',
  primaryLanguageHint: 'Write the title and body in this language. Other languages are generated from it.',
  ...
  languageVariantsHint:
    'The primary language is always included. Selected extra languages are translated and given audio on save if they have no staff-written copy yet.',
  primaryIncluded: 'primary',
  saveExhibit: 'Save',
  savingExhibit: 'Saving…',
  localizeDone: 'Translations and narration audio were generated.',
  ...
  generateAudioHint: 'Narration audio is generated on save for languages that do not have it yet.',
...
const vi: { [K in keyof typeof en]: string } = {
  ...
  titlePlaceholderEn: 'Cham statue',
  editExhibitHint:
    'Sửa hiện vật như viết blog. Lưu sẽ cập nhật ngôn ngữ chính và bổ sung bản dịch còn thiếu.',
  primaryLanguage: 'Ngôn ngữ chính',
  primaryLanguageHint: 'Viết tiêu đề và nội dung bằng ngôn ngữ này. Các ngôn ngữ khác được tạo từ đây.',
  ...
  languageVariantsHint:
    'Ngôn ngữ chính luôn được giữ. Các ngôn ngữ thêm sẽ được dịch và tạo âm thanh khi lưu nếu chưa có bản nhân viên viết.',
  primaryIncluded: 'chính',
  saveExhibit: 'Lưu',
  savingExhibit: 'Đang lưu…',
  localizeDone: 'Đã tạo bản dịch và âm thanh thuyết minh.',
  ...
  generateAudioHint: 'Âm thanh thuyết minh được tạo khi lưu cho ngôn ngữ chưa có audio.',
