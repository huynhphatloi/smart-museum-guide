...
import { BeaconFormDialog } from '@/components/beacon-form-dialog';
      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            BLE hardware installed in a zone. The identifier is what the mobile app reports back.
          </p>
        </div>
              ...
              <TableBody>
                {beaconsQuery.data.items.map((beacon) => (
                  <TableRow key={beacon.id}>
                    ...
                    <TableCell className="text-xs text-muted-foreground">
                      {beacon.minRssi !== null ? `${beacon.minRssi} dBm` : 'app default'}
                    </TableCell>
                    <TableCell>
